...
urlpatterns = [
    ...
    path("media/images/upload/", FrontendImageUploadView.as_view(), name="frontend-upload-image"),
    path("media/videos/upload/", FrontendVideoUploadView.as_view(), name="frontend-upload-video"),
