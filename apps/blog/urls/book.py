...
from apps.blog.views.book import BookDetailView, BookListView, BookShareDetailView, BookShareLinkCreateView, BookStarToggleView

urlpatterns = [
    path("books/", BookListView.as_view(), name="book-list"),
    path("book/<slug:slug>/star/", BookStarToggleView.as_view(), name="book-star-toggle"),
